...
Vandaag heb ik een start gemaakt aan het eerste prototype en het bedenken van vragen die ik mijn user morgen wil stellen. Omdat de test al morgen is was dit wel flink doorwerken. Ik heb gekozen voor de casus waarbij Ihab spraakberichten wil sturen en ontvangen. Ik ga focussen op het ontvangen en deze ervaring verbeteren. Omdat het mij moeilijk leek al een heel prototype op te zetten heb ik een simpele chat applicatie gemaakt waarin er wat berichtjes over en weer worden gestuurd. Het is ook mogelijk om berichten te versturen. Een van de berichten is een spraakbericht, waarin ik wat vragen stel waar Ihab morgen antwoord op moet proberen te geven in de chat. Hiermee wil ik testen tegen welke problemen hij aanloopt als ik een naïeve benadering volg.

De vragen bedenken en het prototype maken kostte een uur of zes.
...
Ihab is volledig afhankelijk van screenreaders om content van apps en websites te begrijpen. Hij heeft een voorbeeld laten zien van een app die niet goed werkt, namelijk de app _Insta360_ die hij gebruikt voor een camera. Deze app is volledig visueel ingesteld en is niet mogelijk te navigeren met shortcuts of voor te lezen met een screenreader. Hij kan deze app op geen enkele manier gebruiken.

...
_Omdat ik voor de herkansing moest gaan om een extra test uit te voeren heb ik het assessment gebruikt om met Vasilis te bespreken wat voor functionaliteit ik nog zou kunnen toevoegen ik heb daarom hieronder enkel een korte samenvatting van dit gesprek opgenomen en mijn toegepaste iteratie op het eindproduct_

## Extra 'test' met Vasilis

Ik heb met Vasilis mijn voortgang besproken tijdens dit project. Ik had aangegeven de volgende iteraties tijdens de tests toe te passen:

1. Bij de eerste test heb ik express een slechte app gemaakt om te zien wat er mis ging. De verbetering die hieruit naar voren kwam is dat het een goed idee was om shortcuts toe te voegen.
2. Bij de tweede test heb ik de shortcuts toegevoegd. Navigatie ging hierdoor een stuk beter, maar vervolgens kon hij niet vinden welke shortcuts er waren.
3. Bij de derde test heb ik de screenreader laten vertellen welke shortcuts er zijn en heb ik een AI overzicht toegevoegd. Bij de test vond Ihab dit geweldig werken en kon hij de shortcuts eenvoudig vinden.
